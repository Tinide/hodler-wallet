...
Item {
    ...
    function addDarkService(dm,po,t,a,u,p) {
        ...
        var com = darkcom.createObject(_serviceBSV,{domain:dm,port:po,tls:t,auth:a,user:u,pass:p,ct:"BSV"})
        if (com === null) {
    ...
    BSVAgentWhatsOnChain {id:agentWhatsOnChain}
    BSVAgentBlockChair {id:agentBlockChair}
}
