...
AgentBase {
    ...
    property string subPing: "/v1/ltc/main"
    property string subUtxo: "/v1/ltc/main/addrs/:addr:?unspentOnly=true"
    property string subTx: "/v1/ltc/main/txs/:txid:"
    property string subSendTx: "/v1/ltc/main/txs/push"
